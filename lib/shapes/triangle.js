...
Triangle.prototype.init = function(){
  this.A = g2d.toComplexPoint(this.p1).finalize();
  this.B = g2d.toComplexPoint(this.p2).finalize();
  this.C = g2d.toComplexPoint(this.p3).finalize();
...
Triangle.prototype.contains = function (dot) {
  ...
  // compute vectors and dot products specific to this dot

  var P = g2d.toComplexPoint(dot).finalize()
...
Triangle.prototype.rotate = function(angle, center){
  ...
  // center should default to centeroid
  // call this.init();
}
